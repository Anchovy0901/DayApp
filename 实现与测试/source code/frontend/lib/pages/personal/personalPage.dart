  ...
  Widget logout(BuildContext context){
    return Container(
     ...
     child: 
       Align(child: 
        FlatButton(
          child: Text("退出登陆", style:  TextStyle(color:Colors.red, fontSize:18.0, fontWeight: FontWeight.w400)),
          onPressed: (){
            showDialog(
              context: context, 
              builder: (BuildContext context){
                return AlertDialog(
                  ...
                  content: Text("确定退出当前帐号吗?",style: TextStyle(
                    //height: 4.0,
            ...
            Column(
              children: [
                Row(
                  ...
                  children: [
                    IconButton(icon:Icon(Icons.star, color:Colors.blue), onPressed: (){}),
                  ],
                ),
                Container(

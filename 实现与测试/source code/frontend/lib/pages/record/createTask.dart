...
class _CreateTask extends State<CreateTask>
{
  ...
  List<DateTime> _date;
  double _freq=1;
  Color _colorTheme = Colors.lightBlueAccent;
  String _showDate;
  int _iconIndex=0;
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(title: Text("新建打卡"),centerTitle: true,leading: ReturnButton(),),
      body: Form(
        key: _taskKey,
      child:
      ListView(
           ...
           child:Column(
             children: [
               ...
               Row(children: [
                 ...
                 Tag(content:"Keep运动",onChooseTag: onTagChosenCallback,),
                 Tag(content:"不喝奶茶",onChooseTag: onTagChosenCallback,),
               ],),
               Row(children: [
                 Tag(content:"不挑食",onChooseTag: onTagChosenCallback),
                 Tag(content:"早期",onChooseTag: onTagChosenCallback),
                 Tag(content:"软工作业",onChooseTag: onTagChosenCallback,),
         ...
         Divider(),
          ...
          Row(
            children: [
              ...
              Slider(value: _freq, min:1,max:7,divisions: 6,label: "每周"+_freq.round().toString()+"次",

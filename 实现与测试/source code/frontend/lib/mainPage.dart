...
import 'package:frontend/aboutPage.dart';
...
class _MainPage extends State<MainPage> with SingleTickerProviderStateMixin
{
  ...
  listen(){
    var channel = IOWebSocketChannel.connect("ws://121.196.168.214:8000/ws/message/"+userMobile+"/");
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(icon: Icon(Icons.help_outline),onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>new AboutDayPage()));
        },),
